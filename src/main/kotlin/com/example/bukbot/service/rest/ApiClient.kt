...
//            put("username", "unity_group153")
//            put("accessToken", getAccessToken()!!)
//            put("reqId", UUID.randomUUID().toString())
//            put("sportType", "soccer")
//            put("company", item.source.toLowerCase())
//            put("targetType", targetType.toUpperCase())
//            put("matchId", item.matchId)
...
//        )
        val body = FormBody.Builder()
                ...
                .add("targetType", targetType.toUpperCase())
